...
namespace TableTopCrucible.Domain.Services
{
    ...
    public class SaveService : ISaveService
    {
        ...
        private readonly IDirectorySetupService _directorySetupService;

        public SaveService(IItemService itemService, IDirectorySetupService directorySetupService)
        {
            this._itemService = itemService ?? throw new ArgumentNullException(nameof(itemService));
            this._directorySetupService = directorySetupService ?? throw new ArgumentNullException(nameof(directorySetupService));
        }
